...
/*start of work for the stats page*/

app.get('/team_stats', function(req, res) {
	var query1 = 'SELECT game_date, visitor_name, home_score, visitor_score FROM football_games;';
...
app.get('/player_info/post', function(req, res) {
	...
	var query3 = "SELECT COUNT(g.players) AS count FROM football_games g INNER JOIN football_players p";
			query3 += " ON p.ID =  ANY(g.players) WHERE p.id = '"+ player_id +"';";
